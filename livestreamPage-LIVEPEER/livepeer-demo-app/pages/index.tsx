  ...
  return (
    <main className="container pb-12 h-screen m-auto pt-24 lg:pt-40">
      ...
      {/* <ReactHlsPlayer
        ...
        height="auto"
      /> */}
      <h2>Members Only Livestream</h2>
      <ReactPlayer className='react-player'
        url="https://cdn.livepeer.com/hls/28b0dcbtxj45l40z/index.m3u8"
        playing
        width='100%'
        controls
        config={{
      ...
      {/* <div className="App">
        <ReactJWPlayer
          ...
          playlist="https://cdn.livepeer.com/hls/28b0dcbtxj45l40z/index.m3u8"
          onDisplayClick={() => (document.body.style.backgroundColor = "white")}
        />
      </div> */}
